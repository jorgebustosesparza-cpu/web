...
window.ALPHA_I18N = (function () {
  const es = {
    ...
    'price.3.t': 'Aplicaciones', 'price.3.d': 'Web o móvil, conectada a la operación que ya tienes.',
    'price.note': 'Pesos mexicanos. IVA no incluido.', 'phil.t1': 'La IA debe resolver problemas,', 'phil.t2': 'no crear nuevos.',
  ...
  const en = {
    ...
    'price.3.t': 'Applications', 'price.3.d': 'Web or mobile, wired into the operation you already have.',
    'price.note': 'Mexican pesos. Tax not included.', 'phil.t1': 'AI should solve problems,', 'phil.t2': 'not create new ones.',
