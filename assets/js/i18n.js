...
window.ALPHA_I18N = (function () {
  const es = {
    ...
    'p1.t': 'Diagnóstico', 'p1.d': 'Una sesión. Salimos con el mapa de lo que sí conviene automatizar.', 'p1.m': '1 a 2 semanas',
    'p2.t': 'Diseño e integración', 'p2.d': 'Construimos sobre las herramientas que tu equipo ya usa.', 'p2.m': '2 a 4 semanas',
    'p3.t': 'Producción', 'p3.d': 'Lo dejamos corriendo, medido y con tu gente capacitada.', 'p3.m': '4 a 8 semanas',

    'stats.1': 'Diagnóstico', 'stats.1v': '1-2 sem',
    'stats.2': 'Primer sistema en producción', 'stats.2v': '4-8 sem',
    'stats.3': 'Operación automatizada', 'stats.3v': '24/7',
    'stats.4': 'Sobre tus herramientas actuales', 'stats.4v': '100%',
    ...
    'faq.q3': '¿Cuánto tarda?', 'faq.a3': 'El primer sistema en producción toma entre cuatro y ocho semanas, según integraciones.',
  ...
  const en = {
    ...
    'p1.t': 'Diagnosis', 'p1.d': 'One session. We leave with a map of what is worth automating.', 'p1.m': '1 to 2 weeks',
    'p2.t': 'Design and integration', 'p2.d': 'We build on the tools your team already uses.', 'p2.m': '2 to 4 weeks',
    'p3.t': 'Production', 'p3.d': 'We leave it running, measured, with your people trained.', 'p3.m': '4 to 8 weeks',

    'stats.1': 'Diagnosis', 'stats.1v': '1-2 wks',
    'stats.2': 'First system in production', 'stats.2v': '4-8 wks',
    'stats.3': 'Automated operation', 'stats.3v': '24/7',
    'stats.4': 'On your current tools', 'stats.4v': '100%',
    ...
    'faq.q3': 'How long does it take?', 'faq.a3': 'The first system in production takes four to eight weeks, depending on integrations.',
